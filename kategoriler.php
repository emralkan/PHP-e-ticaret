		...
		<div class="row">
			<div class="col-md-9"><!--Main content-->
				<div class="title-bg">
					...
					<div class="title-nav">
						<a href="category-list.htm"><i class="fa fa-th-large"></i>grid</a>
				...
				while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {?>
					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								<div class="hot"></div>
								<a href="urun-<?=seo($uruncek["urun_seourl"])?>"><img src="images\sample-3.jpg" alt="" class="img-responsive"></a>
							...
							<span class="smalltitle"><a href="kategori-<?=seo($kategoricek["kategori_ad"])?>"><?php  echo substr( $uruncek['urun_ad'],0,5,); ?></a></span>
