				...
				<div class="page-title-inner">
					<div class="row">
						<div class="col-md-12">
							...
							<p >Kullanıcı kayıt işlemlerini aşağıdaki form aracılığı ile gerçekleştirebilirsiniz.</p>
						</div>
	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="alert alert-danger">
					<strong>Harika!</strong> Kaydınız Başarılı bir şekilde yapılmıştır. Giriş Yapabilirsiniz.
				</div>
