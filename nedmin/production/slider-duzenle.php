          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                ...
                <input type="" id="first-name" name="slider_ad" disabled="" value="<?php echo $slidercek['slider_ad']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Slider Resim Uzantı <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="slider_resimyol" <?php echo $slidercek['slider_resimyol'] ?>  value="<?php echo $slidercek['slider_resimyol'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
