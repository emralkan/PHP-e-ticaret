        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>E-Ticaret </span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cogs"></i>Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="hakkimizda-ayar.php">Hakkımızda Ayarları</a></li>
                      <li><a href="menu.php">Menü Ayarları</a></li>
                      <li><a href="slider.php">Slider Ayarları</a></li>
                      <li><a href="kategori.php">Kategori Ayarları</a></li>
                      <li><a href="urunler.php">Ürün Ayarları</a></li>
                      <li><a href="yorumlar.php">Yorum Ayarları</a></li>
